...
Mapbox library [earcut.hpp](https://github.com/mapbox/earcut.hpp) for constrained polygon triangulation.  Triangulation by ear-clipping (or ear-cutting) is path-based, simple features compliant POLYGON analogues are the basic input. 
